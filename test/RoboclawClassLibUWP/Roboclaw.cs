...
namespace RoboclawClassLibUWP
{
    ...
    {
        public static Windows.Devices.SerialCommunication.SerialDevice canPort;
    ...
    public class SerialDevice
    {
        ...
        public static Dictionary<string, Windows.Devices.SerialCommunication.SerialDevice> serialPorts = new Dictionary<string, Windows.Devices.SerialCommunication.SerialDevice>();
        ...
        public SerialDevice(string comport, int baudrate)
        {
            ...
            if (!serialPorts.ContainsKey(m_comport))
            {
                ...
                serialPorts.Add(m_comport, new SerialDevice(m_comport, m_baudrate));
